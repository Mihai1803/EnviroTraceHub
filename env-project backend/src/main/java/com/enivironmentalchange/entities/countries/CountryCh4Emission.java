...
@Entity
@Table(name = "country_ch4_emission")
public class CountryCh4Emission {
    ...
    public CountryCh4Emission () {

    }

    public CountryCh4Emission(int year, int emission) {
        this.year = year;
